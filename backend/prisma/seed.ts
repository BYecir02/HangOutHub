...
async function main() {
  ...
  const cotonouPlacesData = [
    ...
    },
    {
      ...
      description: 'Une reference incontournable a Cotonou pour deguster des poissons frais et des fruits de mer les pieds dans le sable.',
      address: 'Route des Peches, Fidjrosse, Cotonou',
      latitude: 6.342,
      longitude: 2.368,
      priceLevel: 3,
      avgRating: 4.6,
    ...
    {
      name: 'Le Livingstone',
      description: 'Restaurant-bar chaleureux et incontournable de la Haie Vive, proposant une cuisine fusion, de succulentes pizzas et une ambiance conviviale.',
      address: 'Haie Vive, Cotonou',
      latitude: 6.356,
      longitude: 2.385,
      priceLevel: 2,
      avgRating: 4.4,
      coverUrl: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=1200',
      images: ['https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=1200'],
      cityId: cotonou.id,
      category: 'Restaurant',
    },
    {
      name: 'Ferrari Lounge Cotonou',
      description: 'Lounge huppe et festif au design moderne, repute pour ses cocktails sophistiques, sa cuisine moderne et ses soirees DJ sets.',
      address: 'Akpakpa, Cotonou',
      latitude: 6.375,
      longitude: 2.441,
      priceLevel: 3,
      avgRating: 4.5,
      coverUrl: 'https://images.unsplash.com/photo-1514933651103-005eec06c04b?w=1200',
      images: ['https://images.unsplash.com/photo-1514933651103-005eec06c04b?w=1200'],
      cityId: cotonou.id,
      category: 'Bar & Lounge',
    },
    {
      name: 'Tam Tam Fidjrosse',
      description: 'Restaurant-bar de plage chaleureux au cadre cocooning, parfait pour des cocktails exotiques, des grillades et des soirees karaoke.',
      address: 'Route des Peches, Fidjrosse, Cotonou',
      latitude: 6.345,
      longitude: 2.361,
      priceLevel: 2,
      avgRating: 4.3,
      coverUrl: 'https://images.unsplash.com/photo-1498654896293-37aacf113fd9?w=1200',
      images: ['https://images.unsplash.com/photo-1498654896293-37aacf113fd9?w=1200'],
      cityId: cotonou.id,
      category: 'Bar & Lounge',
    },
    {
      name: 'La Nouvelle Brasserie',
      description: 'Brasserie intime et elegante offrant une superbe fusion de cuisine francaise raffinee et de touches locales africaines.',
      address: 'Haie Vive, Cotonou',
      latitude: 6.357,
      longitude: 2.383,
      priceLevel: 3,
      avgRating: 4.7,
      coverUrl: 'https://images.unsplash.com/photo-1550966871-3ed3cdb5ed0c?w=1200',
      images: ['https://images.unsplash.com/photo-1550966871-3ed3cdb5ed0c?w=1200'],
      cityId: cotonou.id,
      category: 'Restaurant',
    },
  ];
  ...
  const placeTagRules: Array<{
    ...
    {
      tag: 'Fruits de mer',
      match: (name) => name.includes('pecheur') || name.includes('fruits de mer'),
    },
    {
      tag: 'Gastronomique',
      match: (name) => name.includes('brasserie') || name.includes('livingstone') || name.includes('gastronomique'),
    },
    {
      tag: 'Rooftop',
      match: (name) => name.includes('rooftop') || name.includes('ferrari lounge'),
    },
    {
      tag: 'Cocktails',
      match: (name) => name.includes('lounge') || name.includes('tam tam'),
    },
  ];
