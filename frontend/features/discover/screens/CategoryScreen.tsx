...
export default function CategoryDiscoverScreen() {
    ...
    const fetchCategory = async () => {
      ...
      try {
        ...
        try {
          ...
          console.error('Erreur chargement preferences catégorie:', error);
          if (isMounted) {
            setPreferenceSnapshot({
              tagIds: [],
              cityIds: [],
  ...
  const visibleEvents = useMemo(
    () => rankEvents(locationFilteredEvents, selectedLocation, preferenceSnapshot),
    [locationFilteredEvents, preferenceSnapshot, selectedLocation],
  );

  const visiblePlaces = useMemo(
    () => rankPlaces(locationFilteredPlaces, selectedLocation, preferenceSnapshot),
