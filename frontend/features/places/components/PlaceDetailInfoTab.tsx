    ...
    <View className="pb-2 pt-4">
      <View className="flex-row items-center py-4">
        ...
        <View className="ml-3 flex-1">
          ...
          {/* Bouton "Voir sur la carte" masque temporairement (onglet Carte en veille).
              Pour le reactiver : remettre `&& false` -> retirer le `false &&`. */}
          {false &&
          place.latitude !== null &&
          ...
          place.longitude !== undefined ? (
            <TouchableOpacity
              ...
              className="mt-3 self-start rounded-full bg-[#ff4757] px-4 py-2"
            >
      ...
      {place.phone ? (
        <>
          <View className="h-px bg-gray-100 dark:bg-gray-800" />
          <View className="flex-row items-center py-4">
            <Ionicons name="call-outline" size={20} color="#ff4757" />
            <View className="ml-3 flex-1">
              <Text className="text-xs uppercase tracking-widest text-gray-400 dark:text-gray-500">
      ...
      {place.whatsapp ? (
        <>
          <View className="h-px bg-gray-100 dark:bg-gray-800" />
          <View className="flex-row items-center py-4">
            <Ionicons name="logo-whatsapp" size={20} color="#ff4757" />
            <View className="ml-3 flex-1">
              <Text className="text-xs uppercase tracking-widest text-gray-400 dark:text-gray-500">
