...
type PlacePublicationsPanelProps = {
  placeName: string;
...
export default function PlacePublicationsPanel({
  placeName,
  publications,
  scrollRef,
  visibility,
          ...
          <View className="flex-row items-start justify-between gap-4">
            <View className="flex-1">
              <Text className="text-2xl font-bold text-gray-900 dark:text-white">
                {t('placeDetailPublicationsTitle')}
              </Text>
              <Text className="mt-2 text-sm leading-6 text-gray-600 dark:text-gray-300">
                {t('placeDetailPublicationsSubtitle', { name: placeName })}
              </Text>
            </View>
            <TouchableOpacity
              onPress={onClose}
        ...
        <View className="mt-1 px-5">
          {authRequired ? (
            <ScreenState
              ...
              description={t('placeDetailPublicationsLoginMessage')}
              actionLabel={t('placeDetailPublicationsRetry')}
              onAction={onRetry}
            ...
            <ScreenState
              mode="loading"
              title={t('placeDetailPublicationsLoading')}
              containerClassName="px-0 py-2"
            />
          ) : error ? (
            <ScreenState
              ...
              description={t('placeDetailPublicationsLoadFailed')}
              actionLabel={t('placeDetailPublicationsRetry')}
              onAction={onRetry}
              containerClassName="px-0 py-2"
            />
            ...
            <ScreenState
              mode="empty"
              icon="albums-outline"
              title={t('placeDetailPublicationsEmptyTitle')}
              description={t('placeDetailPublicationsEmptyDescription')}
              containerClassName="px-0 py-2"
            />
          )}
        </View>
